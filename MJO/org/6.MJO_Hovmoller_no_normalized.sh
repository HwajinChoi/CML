...
#---------------------------------------------------------------------------
 ...
 sed s/LAT_S/${LAT_S}/g ./hj_band_pass_hovmueller_plot_no_nor.ncl > ./imsi_1.ncl
 ...
 sed s/MONTH/${MONTH}/g imsi_8.ncl > ./hj_band_pass_hovmueller_plot_no_nor_re.ncl
 rm -f ./imsi_?.ncl
#---------------------------------------------------------------------------

cat > imsi.ncl << EOF
load "./hj_band_pass_hovmueller_plot_no_nor_re.ncl"   
begin
...
${v1}_mjo_num_nor2(0:7,:)=${v1}_mjo_num
${v1}_mjo_num_nor2(8:15,:)=${v1}_mjo_num

${v1}_mjo_num_nor3=${v1}_mjo_num_nor2(:,{30:240})
printMinMax(${v1}_mjo_num_nor3,0)

;----------------------------------------------------------------------------------------
optHov  = False
band_pass_hovmueller_plot(${v1}_mjo_num_nor3,dir3,"png","${v1}_NO_nor_MJO_${SSS}_hovmueller_${months}_${LAT_S}_${LAT_F}_2000-2019",optHov)
end
EOF
