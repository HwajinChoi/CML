...
f=addfile(dir1+"MJO_${s}_Index_PC1_2_19900101-20091231.nc","r")
...
system("rm -f "+dir1+"MJO_${s}_yesno_num_19900101-20091231.nc")
out=addfile(    dir1+"MJO_${s}_yesno_num_19900101-20091231.nc","c")
