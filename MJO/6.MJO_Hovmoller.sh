...
for SSS in "cobalt" "daily_chl" "clim_chl";do
#---------------------------------------------------------------------------
#---------------------------------------------------------------------------
 for v1 in "olr" "tos" "wspd";do
 #for v1 in "temp" ;do
# Variable name
...
dir2="/media/cmlws/Data2/hjc/MJO/data/RE/$s/"
...
g1=addfile(dir2+"${v1}.ano.19900101-20091231.nc","r")
...
;system("rm -f "+dir1+"${v1}_${SSS}_mjo_no_STDV_${months}_${LAT_S}_${LAT_F}_1990-2009.nc")
;out=addfile(dir1+"${v1}_${SSS}_mjo_no_STDV_${months}_${LAT_S}_${LAT_F}_1990-2009.nc","c")
...
;----------------------------------------------------------------------------------------
optHov  = False
band_pass_hovmueller_plot(${v1}_mjo_num_nor3,dir3,"png","${v1}_MJO_${SSS}_hovmueller_${months}_${LAT_S}_${LAT_F}_1990-2009",optHov)
end
EOF
