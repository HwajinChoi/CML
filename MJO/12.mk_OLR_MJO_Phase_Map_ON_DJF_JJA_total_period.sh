...
g=addfile(dir0+"olr.ano.19900101-20091231.nc","r")
...
system("rm -f "+dir1+"OLR_${SSS}_${months}_MJO_Phase_8_total_period.nc")
out=addfile(dir1+"OLR_map_${SSS}_${months}_MJO_Phase_8_total_period.nc","c")
