...
plot2(8)=gsn_csm_contour(wks,hgt_8(2,:,:),res4)
 ...
 gsn_text_ndc(wks,"Tibetan high (200hpa)",0.55,0.87,txres)

 txres@txFontHeightF = 0.025                     ; text font height
  dum = new(9,graphic)
  dum(0) = gsn_add_text(wks,plot(0),"12480",90,29,txres)
  dum(3) = gsn_add_text(wks,plot(3),"12480",90,29,txres)
  dum(6) = gsn_add_text(wks,plot(6),"12480",90,29,txres)

  dum(1) = gsn_add_text(wks,plot(1),"12480",90,35,txres)
  dum(4) = gsn_add_text(wks,plot(4),"12480",90,35,txres)
  dum(7) = gsn_add_text(wks,plot(7),"12480",90,35,txres)

  dum(2) = gsn_add_text(wks,plot(2),"12480",90,34,txres)
  dum(5) = gsn_add_text(wks,plot(5),"12480",90,34,txres)
  dum(8) = gsn_add_text(wks,plot(8),"12480",90,34,txres)

 txres@txFontColor="green"
  dum1 = new(9,graphic)
  dum1(0) = gsn_add_text(wks,plot(0),"12480",170,17,txres)
  dum1(3) = gsn_add_text(wks,plot(3),"12480",153,12,txres)
  dum1(6) = gsn_add_text(wks,plot(6),"12480",150,17,txres)

  dum1(1) = gsn_add_text(wks,plot(1),"12480",150,13,txres)
  dum1(4) = gsn_add_text(wks,plot(4),"12480",150,15,txres)
  dum1(7) = gsn_add_text(wks,plot(7),"12480",155,28,txres)

  dum1(2) = gsn_add_text(wks,plot(2),"12480",161,30,txres)
  dum1(5) = gsn_add_text(wks,plot(5),"12480",162,15,txres)
  dum1(8) = gsn_add_text(wks,plot(8),"12480",170,17,txres)
