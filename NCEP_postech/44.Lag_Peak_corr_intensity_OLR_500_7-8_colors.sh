...
;---------------------------------------------------------------------------
NWmax=(/73,55,69,59,59,58,63,45,71,56/)
X=30
olr_indo_2=new((/10,2*X+1/),"float")
olr_china_2=new((/10,2*X+1/),"float")
hgt_2=new((/10,2*X+1/),"float")
do i=0,9
 hgt_2(i,:)=hgt_10(i,NWmax(i)-X:NWmax(i)+X)
 olr_indo_2(i,:)=orl_indo_10(i,NWmax(i)-X:NWmax(i)+X)
 olr_china_2(i,:)=orl_china_10(i,NWmax(i)-X:NWmax(i)+X)
end do
;---------------------------------------------------------------------------
mylag=10
...
;---------------------------------------------------------------------------
 ...
 lineres = True
 lineres@lgLineColors = colors_NPH 
