...
;---------------------------------------------------------------------------
do K=0,3
 wks = gsn_open_wks("png",dir2+"SIG_6_9_ratio_total_Intensity_India_OLR_"+YEAR(K)+"_clim_hgt_${h}_"+per)
...
;---Set a title on right Y axis.
 ...
 textres@lgLabels = (/"NW India"/)  ; legend labels (required)
 bar_plot = simple_legend(wks,bar_plot,gres,lineres,textres)

 xy_plot= gsn_csm_xy (wks,y2,OLR(0,K,:),xyres)
