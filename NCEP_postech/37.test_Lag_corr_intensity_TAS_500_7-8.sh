...
;---------------------------------------------------------
;---------------------------------------------------------
tas_NPH=(/2006,2010,2012,2016,2018,2020/) ; ALL data which plus lag is greater than the lag zero

CCR_tas=new((/6,2*mylag+1/),float)
CCR_tas(0,:)=ccr_tas_10(3,:)
CCR_tas(1,:)=ccr_tas_10(4,:)
CCR_tas(2,:)=ccr_tas_10(5,:)
CCR_tas(3,:)=ccr_tas_10(6,:)
CCR_tas(4,:)=ccr_tas_10(7,:)
CCR_tas(5,:)=ccr_tas_10(8,:)
