...
hgt_mv_area2=where(hgt_mv_11_7_9 .ge. P,hgt_mv_11_7_9,hgt_mv_11_7_9@_FillValue)
indo_OLR_cases_7_9=where(hgt_mv_11_7_9 .ge. P,OLR_cases_7_9(0,:,:),OLR_cases_7_9@_FillValue)
china_OLR_cases_7_9=where(hgt_mv_11_7_9 .ge. P,OLR_cases_7_9(1,:,:),OLR_cases_7_9@_FillValue)
copy_VarMeta(hgt_mv_11_7_9,hgt_mv_area2)
copy_VarMeta(OLR_cases_7_9(0,:,:),indo_OLR_cases_7_9)
copy_VarMeta(OLR_cases_7_9(0,:,:),china_OLR_cases_7_9)

indo_corr2=escorc_n(hgt_mv_area2,indo_OLR_cases_7_9,1,1)
china_corr2=escorc_n(hgt_mv_area2,china_OLR_cases_7_9,1,1)
;print(china_corr2)
;exit
;-----------------------------------------
; It is a checking proccess of  missisng values for correlations which meet the criteria
;-----------------------------------------
N11 = num(.not.ismissing(hgt_mv_area2(0,:)))
N22 = num(.not.ismissing(hgt_mv_area2(1,:)))
N33 = num(.not.ismissing(hgt_mv_area2(2,:)))
print(N11)
print(N22)
print(N33)
exit
...
;---------------------------------------------------------------------------
do K=0,2
 wks = gsn_open_wks("png",dir2+"Intensity_India_china_OLR_"+YEAR(K)+"_clim_hgt_${h}_"+per)
