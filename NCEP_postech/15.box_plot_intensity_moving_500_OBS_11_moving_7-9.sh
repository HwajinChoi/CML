...
tas_mv_11_6_9=tas_mv_11_k; year(32) x time 87 (7-9)
;-------------------------------------------------------------------
...
hgt_mv_11_6_9=hgt_mv_11(:,31:142) ; time 87 (7-9)
;-------------------------------------------------------------------
...
;-------------- For statistics ----------------------------------------------------
; tas_mv_11_6_9 ; year (32) x time (87) 
; HGT_mv_11_6_9
;----------------------------------------------------------------------------------
;----------------------------------------------------------------------------------
M=(/"June","July","August","September"/)
tas_mv_11_6=tas_mv_area(:,0:24) ; June
HGT_mv_11_6=hgt_mv_area(:,0:24)
tas_mv_11_7=tas_mv_area(:,25:55) ; July
HGT_mv_11_7=hgt_mv_area(:,25:55)
tas_mv_11_8=tas_mv_area(:,56:86) ; August
HGT_mv_11_8=hgt_mv_area(:,56:86)
tas_mv_11_9=tas_mv_area(:,87:111) ; September
HGT_mv_11_9=hgt_mv_area(:,87:111)

tas_mv_11_6_cases=tas_mv_area_cases(:,0:24) ; July
HGT_mv_11_6_cases=hgt_mv_area_cases(:,0:24)
tas_mv_11_7_cases=tas_mv_area_cases(:,25:55) ; July
HGT_mv_11_7_cases=hgt_mv_area_cases(:,25:55)
tas_mv_11_8_cases=tas_mv_area_cases(:,56:86) ; August
HGT_mv_11_8_cases=hgt_mv_area_cases(:,56:86)
tas_mv_11_9_cases=tas_mv_area_cases(:,87:111) ; September
HGT_mv_11_9_cases=hgt_mv_area_cases(:,87:111)
;----------------------------------------------------------------------------------
;------- You need to change here!! --------------------------------------------------
;----------------------------------------------------------------------------------
mm=9
tas_mv_11_6_9_2=ndtooned(tas_mv_11_9)
HGT_mv_11_6_9_2=ndtooned(HGT_mv_11_9)

tas_mv_11_6_9_cases_2=tas_mv_11_9_cases
HGT_mv_11_6_9_cases_2=HGT_mv_11_9_cases
;----------------------------------------------------------------------------------
mmm=mm-7
;----------------------------------------------------------------------------------
...
tas_case_04=where(HGT_mv_11_6_9_cases_2 .ge. 0.4 .and. HGT_mv_11_6_9_cases_2 .lt. 0.5,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
tas_case_05=where(HGT_mv_11_6_9_cases_2 .ge. 0.5 .and. HGT_mv_11_6_9_cases_2 .lt. 0.6,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
tas_case_06=where(HGT_mv_11_6_9_cases_2 .ge. 0.6 .and. HGT_mv_11_6_9_cases_2 .lt. 0.7,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
tas_case_07=where(HGT_mv_11_6_9_cases_2 .ge. 0.7 .and. HGT_mv_11_6_9_cases_2 .lt. 0.8,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
tas_case_08=where(HGT_mv_11_6_9_cases_2 .ge. 0.8 .and. HGT_mv_11_6_9_cases_2 .lt. 0.9,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
tas_case_09=where(HGT_mv_11_6_9_cases_2 .ge. 0.9 .and. HGT_mv_11_6_9_cases_2 .lt. 1.0,tas_mv_11_6_9_cases_2,tas_mv_11_6_9_cases_2@_FillValue)
...
colors="black"
;---------------------------------------------------------------------------
 wks = gsn_open_wks("png",dir2+"6_9_Box_plot_"+M(mmm)+"_"+C+"_OBS_Intensity_hgt_${h}_"+per)
 plot=new(1,"graphic")
 res   = True
 ...
 res@tiMainString = "North Pacific High ("+C+", 40%, "+M(mmm)+")"
 ;**********************************************
...
;***********************************************
 ...
 ; dum1 = gsn_add_polymarker(wks,plot,x,M_2016,mres) ; July
 ; dum1 = gsn_add_polymarker(wks,plot,x(0:4),M_2016(0:4),mres);August 
  dum1 = gsn_add_polymarker(wks,plot,x(0:1),M_2016(0:1),mres) 
  mres@gsMarkerColor = "blue"                   ; polymarker color
 ; dum2 = gsn_add_polymarker(wks,plot,x,M_2018,mres) ; July
  dum2 = gsn_add_polymarker(wks,plot,x(0:1),M_2018(0:1),mres) 
 ; dum2 = gsn_add_polymarker(wks,plot,x(0:4),M_2018(0:4),mres) ;August 
  ...
  dum3 = gsn_add_polymarker(wks,plot,x(0:1),M_2020(0:1),mres) 
