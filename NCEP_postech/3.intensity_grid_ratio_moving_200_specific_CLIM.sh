...
hgt_mv_CLIM_neg=where(hgt_mv_area_CLIM2 .lt. 0, hgt_mv_area_CLIM2, hgt_mv_area_CLIM2@_FillValue)
hgt_mv_CLIM_pos=where(hgt_mv_area_CLIM2 .gt. 0, hgt_mv_area_CLIM2, hgt_mv_area_CLIM2@_FillValue)
copy_VarMeta(hgt_mv_area_CLIM2,hgt_mv_CLIM_neg)
copy_VarMeta(hgt_mv_area_CLIM2,hgt_mv_CLIM_pos)
hgt_mv_CLIM_pos@_FillValue=hgt_mv_area_CLIM2@_FillValue
hgt_mv_CLIM_neg@_FillValue=hgt_mv_area_CLIM2@_FillValue
print(hgt_mv_CLIM_pos)
print(hgt_mv_CLIM_neg)
exit

y5=ispan(6,148,1)
;---------------------------------------------------------------------------

wks = gsn_open_wks("png",dir2+"Intensity_count_moving_2016_2018_2020_clim_hgt_${h}_CLIM_"+per)
plot=new(4,"graphic")
plot1=new(4,"graphic")
 res   = True
 ...
 res@gsnXYBarChartColor   =(/"black"/)
 res@gsnAboveYRefLineBarColor = (/"black"/)
 res@gsnBelowYRefLineBarColor = (/"black"/)
 plot(3) = gsn_csm_xy (wks,fspan(6.3,148.3,143),hgt_mv_CLIM_pos,res)
 res@gsnCenterString=""
 plot1(3) = gsn_csm_xy (wks,fspan(6.3,148.3,143),hgt_mv_CLIM_neg,res)
