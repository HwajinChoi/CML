...
hgt_mv_11_6_9=hgt_mv_11(:,31:142) ; time 112 (6-9)
;-------------------------------------------------------------------
...
tas_02=where(HGT_mv_11_6_9_2 .ge. 0.2 .and. HGT_mv_11_6_9_2 .lt. 0.3,tas_mv_11_6_9_2,tas_mv_11_6_9_2@_FillValue)
tas_03=where(HGT_mv_11_6_9_2 .ge. 0.3 .and. HGT_mv_11_6_9_2 .lt. 0.4,tas_mv_11_6_9_2,tas_mv_11_6_9_2@_FillValue)
...
tas_case_02=where(HGT_mv_11_cases .ge. 0.2 .and. HGT_mv_11_cases .lt. 0.3,TAS_mv_11_cases,TAS_mv_11_cases@_FillValue)
tas_case_03=where(HGT_mv_11_cases .ge. 0.3 .and. HGT_mv_11_cases .lt. 0.4,TAS_mv_11_cases,TAS_mv_11_cases@_FillValue)
...
copy_VarMeta(TAS_mv_11_cases,tas_case_02)
copy_VarMeta(TAS_mv_11_cases,tas_case_03)
...
m_02=dim_median_n(tas_case_02,1)
m_03=dim_median_n(tas_case_03,1)
...
;---------------------------------------------------------------------------
S2=stat_dispersion(tas_02,True)
S3=stat_dispersion(tas_03,True)
...
TAS=new((/8,5/),"float"); for box plot
TAS(0,0)=S2(2)
TAS(0,1)=S2(6)
TAS(0,2)=S2(8)
TAS(0,3)=S2(10)
...
;---------------------------------------------------------------------------
 ...
 res@tiMainString = "North Pacific High ("+C+", 40% Jun-Sep)"
 ;**********************************************
...
;***********************************************
;***********************************************
  plot = boxplot(wks,x,TAS(2:7,:),opti,res,llres)	; All 3 options used...
;***********************************************
...
;***********************************************
  ...
  dum1 = gsn_add_polymarker(wks,plot,x,M_2016(2:7),mres) 
  mres@gsMarkerColor = "blue"                    ; polymarker color
  dum2 = gsn_add_polymarker(wks,plot,x,M_2018(2:7),mres) 
  mres@gsMarkerColor = "green"                    ; polymarker color
  dum3 = gsn_add_polymarker(wks,plot,x,M_2020(2:7),mres) 
