...
hgt_mask=where(hgt .ge. C, 1,0) ; for 500 hpa
...
;-----Raw data---------------------------------------------------------------
hgt_count_clim=dim_avg_n_Wrap(hgt_count2,0)
;-----5 days averaged--------------------------------------------------------
...
system("rm -f ${dir1}/hgt_count_"+C+"_mv_11_1991-2020.nc")
out6=addfile("${dir1}/hgt_count_"+C+"_mv_11_1991-2020.nc","c")
