...
TAS_mv_11_cases=new((/3,62/),"float")
...
tas_10=new((/7,62/),"float")
pr_10=new((/7,62/),"float")
...
;---------------------------------------------------------------------------
 wks = gsn_open_wks("png",dir2+"7_8_Lag_Corr_TAS_PR_Intensity_hgt_${h}_"+per)
 plot=new(2,"graphic")
 plot1=new(2,"graphic")
 plot2=new(2,"graphic")
 res   = True
