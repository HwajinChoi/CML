...
plot=new(1,"graphic")
 ...
 res@gsnLeftString=""
 res@gsnCenterString="Tibetan high ( "+per+" ;200hpa; 1991-2022)"
 res@xyLineColors       = CC 
...
; txres@txAngleF      = 90.
 ...
 gsn_text_ndc(wks, "(58)",  0.98, 0.877, txres);2022
 gsn_text_ndc(wks, "(20)",  0.98, 0.853, txres);2021
 gsn_text_ndc(wks, "(36)",  0.98, 0.829, txres);2020

 gsn_text_ndc(wks, "(32)",  0.98, 0.805, txres);2019
 gsn_text_ndc(wks, "(54)",  0.98, 0.781, txres)
 gsn_text_ndc(wks, "(27)",  0.98, 0.757, txres)
 gsn_text_ndc(wks, "(43)",  0.98, 0.733, txres)
 gsn_text_ndc(wks, "(14)",  0.98, 0.709, txres)
 gsn_text_ndc(wks, "(21)",  0.98, 0.685, txres)
 gsn_text_ndc(wks, "(52)",  0.98, 0.661, txres)
 gsn_text_ndc(wks, "(38)",  0.98, 0.637, txres)
 gsn_text_ndc(wks, "(21)",  0.98, 0.613, txres)
 gsn_text_ndc(wks, "(56)",  0.98, 0.589, txres);2010

 gsn_text_ndc(wks, "(19)",  0.98, 0.565, txres)
 gsn_text_ndc(wks, "(22)",  0.98, 0.541, txres)
 gsn_text_ndc(wks, "(21)",  0.98, 0.517, txres)
 gsn_text_ndc(wks, "(50)",  0.98, 0.493, txres)
 gsn_text_ndc(wks, "(14)",  0.98, 0.469, txres)
 gsn_text_ndc(wks, "(9)",  0.98, 0.445, txres)
 gsn_text_ndc(wks, "(13)",  0.98, 0.421, txres)
 gsn_text_ndc(wks, "(13)",  0.98, 0.397, txres)
 gsn_text_ndc(wks, "(14)",  0.98, 0.373, txres)
; gsn_text_ndc(wks, "()",  0.98, 0.349, txres) ;2000

 gsn_text_ndc(wks, "(22)",  0.98, 0.325, txres) ; 1999
 gsn_text_ndc(wks, "(18)",  0.98, 0.301, txres)
 gsn_text_ndc(wks, "(11)",  0.98, 0.277, txres)
 gsn_text_ndc(wks, "(16)",  0.98, 0.253, txres)
 gsn_text_ndc(wks, "(32)",  0.98, 0.229, txres)
 gsn_text_ndc(wks, "(30)",  0.98, 0.205, txres)
; gsn_text_ndc(wks, "()",  0.98, 0.179, txres)
 gsn_text_ndc(wks, "(12)",  0.98, 0.156, txres)
 gsn_text_ndc(wks, "(19)",  0.98, 0.135, txres)
