...
; txres@txAngleF      = 90.
 gsn_text_ndc(wks, "corr = 0.54* ",  0.4, 0.59, txres) ; 7-9
 gsn_text_ndc(wks, "corr = 0.55* ",  0.85, 0.59, txres) ; 7
 gsn_text_ndc(wks, "corr = 0.51* ",  0.4, 0.21, txres) ; 8
 gsn_text_ndc(wks, "corr = 0.35* ",  0.85, 0.21, txres) ; 9
