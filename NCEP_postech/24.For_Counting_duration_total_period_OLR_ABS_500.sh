...
olr_indo2=where(olr_indo .lt. olr_clim_indo1,olr_indo,olr_indo@_FillValue)
olr_china2=where(olr_china .lt. olr_clim_china1,olr_china,olr_china@_FillValue) 
...
yyyy=ispan(37,148,1)
;---------------------------------------------------------------------------
wks = gsn_open_wks("png",dir2+"For_COUNT_moving_OLR_ABS_CLIM_Indo_China_91-22_hgt_${h}_"+per)
plot=new(2,"graphic")
plot1=new(2,"graphic")
plot2=new(2,"graphic")
 res   = True
...
pres@gsnPanelMainString        =   "NPH & NW India, S. China sea | ABS Clim"
