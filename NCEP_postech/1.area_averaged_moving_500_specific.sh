...
;---------------------------------------------------------------------------
h1=addfile("${dir2}/hgt_Ave_clim.nc","r") ; 2016, 2018, 2020
hgt_Ave_clim_org=h1->hgt_Ave_clim

h2=addfile("${dir2}/hgt_5days_avg.nc","r")
hgt_5days_avg_org=h2->hgt_5days_avg

h3=addfile("${dir2}/hgt_mv_5_avg.nc","r")
hgt_mv_5_avg_org=h3->hgt_mv_5_avg

h4=addfile("${dir2}/hgt_mv_7_avg.nc","r")
hgt_mv_7_avg_org=h4->hgt_mv_7_avg

h5=addfile("${dir2}/hgt_mv_9_avg.nc","r")
hgt_mv_9_avg_org=h5->hgt_mv_9_avg

h6=addfile("${dir2}/hgt_mv_11_avg.nc","r")
...
wks = gsn_open_wks("png",dir2+"moving_2016_2018_2020_clim_hgt_${h}")
plot=new(6,"graphic")
plot0=new(6,"graphic")
plot1=new(6,"graphic")
 res   = True
 ...
 plot1(0) = gsn_csm_xy (wks,y,hgt_Ave_clim_org,res3)
 ...
 res@gsnYRefLine       =(/5850,5880/)
 res@gsnYRefLineColors = (/"darkorange2","black"/)
 res@gsnYRefLineDashPatterns=(/1,1/)
 res@gsnYRefLineThicknesses=(/2,1/)
 ...
 gres = True
 gres@YPosPercent = 19.    ; expressed as %, 0->100, sets position of top border of legend 
 ...
 pres                       =   True
 pres@gsnFrame         = False
 pres@gsnPanelMainString=${h}+"hpa (2016, 2018, 2020)"
