...
olr_indo_for_sig=dim_avg_n_Wrap(olr_indo0,1)
...
olr_china=h4->orl
olr_china_for_sig=dim_avg_n_Wrap(olr_china,1)
...
yyyy=ispan(37,148,1)
;---------------------------------------------------------------------------
wks = gsn_open_wks("png",dir2+"For_COUNT_moving_OLR_ABS_CLIM_STDV_"+SSS+"_Indo_China_91-22_hgt_${h}_"+per)
plot=new(2,"graphic")
plot1=new(2,"graphic")
plot2=new(2,"graphic")
 res   = True
