...
olr_for_sig_indo=olr_for_clim(:,{20:30},{70:80})
olr_for_sig_indo1=dim_avg_n_Wrap(olr_for_sig_indo,1)
olr_for_sig_indo2=dim_avg_n_Wrap(olr_for_sig_indo1,1)
olr_indo_stdv=stddev(olr_for_sig_indo2)

olr_for_sig_china=olr_for_clim(:,{15:25},{105:130})
olr_for_sig_china1=dim_avg_n_Wrap(olr_for_sig_china,1)
olr_for_sig_china2=dim_avg_n_Wrap(olr_for_sig_china1,1)
olr_china_stdv=stddev(olr_for_sig_china2)

olr_clim=dim_avg_n_Wrap(olr_for_clim,0)
olr_clim_indo=olr_clim({20:30},{70:80})
olr_clim_china=olr_clim({15:25},{105:130})

olr_clim_indo1=avg(olr_clim_indo)
olr_clim_china1=avg(olr_clim_china)

OLR_CLIM_INDO=olr_clim_indo1-(0.5*olr_indo_stdv)
OLR_CLIM_CHINA=olr_clim_china1-(0.5*olr_china_stdv)
...
olr_indo2=where(olr_indo .lt. OLR_CLIM_INDO,olr_indo,olr_indo@_FillValue)
olr_china2=where(olr_china .lt. OLR_CLIM_CHINA,olr_clim_china1,olr_clim_china1@_FillValue) 
...
yyyy=ispan(37,148,1)
;---------------------------------------------------------------------------
wks = gsn_open_wks("png",dir2+"For_COUNT_moving_OLR_ABS_CLIM_STDV_Indo_China_91-22_hgt_${h}_"+per)
plot=new(2,"graphic")
plot1=new(2,"graphic")
plot2=new(2,"graphic")
 res   = True
...
pres@gsnPanelMainString        =   "NPH & NW India, S. China sea | ABS Clim + 0.5 sig"
