...
plot=new(3,"graphic")
 ...
 res@gsnLeftString=""
 res@gsnCenterString="North Pacific high ( "+per+" ;500hpa; 1991-2020)"
...
; txres@txAngleF      = 90.
 gsn_text_ndc(wks, "(7)",  0.78, 0.94, txres)
 gsn_text_ndc(wks, "(20)",  0.78, 0.896, txres)
 gsn_text_ndc(wks, "(13)",  0.78, 0.875, txres)
 gsn_text_ndc(wks, "(15)",  0.78, 0.854, txres)
 gsn_text_ndc(wks, "(32)",  0.78, 0.833, txres)
 gsn_text_ndc(wks, "(36)",  0.78, 0.812, txres)
 gsn_text_ndc(wks, "(14)",  0.78, 0.770, txres)
 gsn_text_ndc(wks, "(10)",  0.78, 0.749, txres)

 gsn_text_ndc(wks, "(58)",  0.78, 0.607, txres)
 gsn_text_ndc(wks, "(13)",  0.78, 0.586, txres)
 gsn_text_ndc(wks, "(20)",  0.78, 0.565, txres)
 gsn_text_ndc(wks, "(23)",  0.78, 0.544, txres)
 gsn_text_ndc(wks, "(36)",  0.78, 0.523, txres)
 gsn_text_ndc(wks, "(14)",  0.78, 0.502, txres)
 gsn_text_ndc(wks, "(20)",  0.78, 0.481, txres)
 gsn_text_ndc(wks, "(25)",  0.78, 0.460, txres)
 gsn_text_ndc(wks, "(14)",  0.78, 0.439, txres)
 gsn_text_ndc(wks, "(32)",  0.78, 0.418, txres)

 gsn_text_ndc(wks, "(40)",  0.78, 0.275, txres)
 gsn_text_ndc(wks, "(18)",  0.78, 0.254, txres)
 gsn_text_ndc(wks, "(56)",  0.78, 0.233, txres)
 gsn_text_ndc(wks, "(22)",  0.78, 0.212, txres)
 gsn_text_ndc(wks, "(32)",  0.78, 0.191, txres)
 gsn_text_ndc(wks, "(20)",  0.78, 0.170, txres)
 gsn_text_ndc(wks, "(11)",  0.78, 0.149, txres)
 gsn_text_ndc(wks, "(24)",  0.78, 0.128, txres)
 gsn_text_ndc(wks, "(44)",  0.78, 0.107, txres)
 gsn_text_ndc(wks, "(8)",  0.78, 0.086, txres)
