...
;---------------------------------------------------------
;---------------------------------------------------------
indo_NPH=(/1995,2006,2016,2020,2022/) ; ALL data which plus lag is greater than the lag zero

CCR_indo=new((/5,2*mylag+1/),float)
CCR_indo(0,:)=ccr_indo_10(1,:)
CCR_indo(1,:)=ccr_indo_10(3,:)
CCR_indo(2,:)=ccr_indo_10(6,:)
...
;                     CASE 2
;---------------------------------------------------------
china_NPH=(/1994,2001,2006,2012,2020/) ; ALL data which plus lag is greater than the lag zero

CCR_china=new((/5,2*mylag+1/),float)
CCR_china(0,:)=ccr_china_10(0,:)
CCR_china(1,:)=ccr_china_10(2,:)
CCR_china(2,:)=ccr_china_10(3,:)
CCR_china(3,:)=ccr_china_10(5,:)
CCR_china(4,:)=ccr_china_10(8,:)
...
;                     CASE 3
;---------------------------------------------------------
delete([/CCR_china,CCR_china2,china_max/])
CCR_china=new((/3,2*mylag+1/),float)
CCR_china(0,:)=ccr_china_10(0,:)
CCR_china(1,:)=ccr_china_10(2,:)
CCR_china(2,:)=ccr_china_10(3,:)
